...
The files for this program are in the directory panair 
...
from the web page https://www.pdas.com/panairrefs.html. 

To compile this program for your machine, use the command
   gfortran  panair.f90 -o panair.exe
Linux and Macintosh users may prefer to omit the .exe on the file name.
If you are unable to do this, you may download 
   https://www.pdas.com/panairexec.zip
containing executables for Windows, Mac, and Linux platforms.
...
distribution.  I am sure that the program in use at Boeing has undergone
